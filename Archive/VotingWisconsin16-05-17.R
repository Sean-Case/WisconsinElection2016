...
# March 2017 municipal GAB data for 2016 election NEED TO RUN -----------------------------------------------------------
...
mardata.repunit.join$paper_prop = with(ward.mardata.2016, paper_ballots / total_ballots)
...
mardata.repunit.join$ballots_counted_at = ward.mardata.2016$ballots_counted_at
mardata.repunit.join$absentee_undeliverable = with(ward.mardata.2016, absentee_undeliverable / absentee_issued)
...
mardata.join$paper_prop = with(mardata.municounty, paper_ballots / total_ballots)
...
repunit.2016.2012.r.dem = join(repunit.2016.2012.r.dem, mardata.repunit.join, by = "reporting_unit")
...
setwd("C:/Users/s_cas/Dropbox/Perso/2016 voting election county results/Wisconsin/All prep together/All processed files/")
    ...
    model.o.repunit.df = with(repunit.2016.2012.o.dem, data.frame(MCD_FIPS,reporting_unit,reporting_unit_orig,county, muni_county,
                                                      ...
                                                      ballots_counted_at, ballots_counted_at_2012, ballots_counted_at_2008,
                                                      absentee_undeliverable, absentee_undeliverable_2012, absentee_undeliverable_2008
))
