...
{ # Preparing basic data
  ...
  ward.2016.o.mun.group = dplyr::group_by(ward.2016.o.l,reporting_unit, municipality,muni_county,county,cand.group)
  ward.2016.o.mun = dplyr::summarise(ward.2016.o.mun.group,
                                     votes.rec2 = sum(votes.rec),
                                     votes.tot2 = mean(votes.tot)
  )
...
{  # Now joining the 2012 data back into the 2016 data
  ...
  # 
  # ward.2016.o.mun = plyr::join(ward.2016.o.mun, back.to.votes.df.join, by = "reporting_unit")
  # 
  ...
  ward.2016.o.mun.g = plyr::join(ward.2016.o.mun.votes.g.cast, ward.12.mun.votes.g.cast, by = "reporting_unit")
...
{   # 2008 ward data
  ...
  {  # Now joining the 2008 data back into the 2016 data
    ...
    ward.2016.o.mun$reporting_unit_orig =ward.2016.o.mun$reporting_unit_orig
    ...
    setdiff(unique(ward.08.mun$reporting_unit), unique(ward.2016.o.mun$reporting_unit))
    setdiff(unique(ward.2016.o.mun$reporting_unit), unique(ward.08.mun$reporting_unit))
    ...
    differences = setdiff(unique(ward.2016.o.mun$reporting_unit),unique(ward.08.mun$reporting_unit))
    vote.2008.diffs = subset(ward.2016.o.mun, reporting_unit %in% differences)
    ...
    # ward.2016.o.mun = plyr::join(ward.2016.o.mun, back.to.votes.df.join, by = "reporting_unit")
    # 
    # ward.2016.o.mun$reporting_unit_2008_agreed = as.character(ward.2016.o.mun$reporting_unit_2008_agreed)
    # 
    # ward.2016.o.mun$reporting_unit_2008_agreed = ifelse(is.na(ward.2016.o.mun$reporting_unit_2008_agreed),
    #                                                  ward.2016.o.mun$reporting_unit,ward.2016.o.mun$reporting_unit_2008_agreed)
    # 
    ...
    ward.2016.o.mun.g = plyr::join(ward.2016.o.mun.votes.g.cast, ward.08.mun.votes.g.cast, by = "reporting_unit")
    
    # 2008 turnout is calculated on the (big?) assumption that the number of registered
    # voters was the same in 2008 as in 2016
    # ward.2016.o.mun.g$turnout.2008 =
    # with(ward.2016.o.mun.g, votes.tot2008 / voters.tot2016) * 100
    
    ward.2016.o.mun.g$dem.perc2008 =
      with(ward.2016.o.mun.g,
           democrat_votes.rec2008 / votes.tot2008) * 100
    ward.2016.o.mun.g$rep.perc2008 =
      with(ward.2016.o.mun.g,
           republican_votes.rec2008 / votes.tot2008) * 100
    ward.2016.o.mun.g$oth.perc2008 =
      with(ward.2016.o.mun.g,
           other_votes.rec2008 / votes.tot2008) * 100
    
    ward.2016.o.mun.g$dem.change.2008.num =
      with(ward.2016.o.mun.g,
           democrat_votes.rec - democrat_votes.rec2008)
    ward.2016.o.mun.g$rep.change.2008.num =
      with(ward.2016.o.mun.g,
           republican_votes.rec - republican_votes.rec2008)
    ward.2016.o.mun.g$oth.change.2008.num =
      with(ward.2016.o.mun.g,
           other_votes.rec - other_votes.rec2008)
    
    ward.2016.o.mun.g$dem.change.2008.perc =
      with(ward.2016.o.mun.g,
           democrat_votes.perc -  dem.perc2008)
    ward.2016.o.mun.g$rep.change.2008.perc =
      with(ward.2016.o.mun.g,
           republican_votes.perc - rep.perc2008)
    ward.2016.o.mun.g$oth.change.2008.perc =
      with(ward.2016.o.mun.g,
    ...
    repunit.2016.2008.o = ward.2016.o.mun.g
