...
# Congressional 2010 data - I got to the start of this ------------------------------------------------
setwd("C:/Users/s_cas/Dropbox/Perso/2016 voting election county results/Wisconsin/All prep together/All processed files")
# getwd()
...
mysheets <- read_excel_allsheets("2010/11.4.2010 Election Results - all offices w x w report.xlsx")
...
cong.2010 <- rbind(mysheets[[6]], mysheets[[7]], mysheets[[8]], mysheets[[9]], mysheets[[10]], mysheets[[11]], mysheets[[12]], mysheets[[13]])
...
{ # 2010 gab stats
  gabdata.2010.cong = read.xlsx2(
    "2010/2010_general_election_gab190f_20150226_xlsx_21131.xlsx",
    stringsAsFactors = F,
    header = T,
    sheetIndex = 1,
    colClasses = NA # Thanks: http://www.briandalessandro.com/blog/how-to-read-numeric-columns-with-read-xlsx2-in-r/
