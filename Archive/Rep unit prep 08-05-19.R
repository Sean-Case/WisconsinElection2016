...
# Governor 2018 data - are open registrants same as registrants from previous years? ------------------------------------------------
setwd("C:/Users/s_cas/Dropbox (NEF Consulting)/2016 voting election county results/Wisconsin/All prep together/All processed files")
getwd()
...
{ # Matching voting statistics with the election statistics
  ...
  gabdata.join$turnout_perc = with(gabdata.repunit, total_ballots / open_registrants)
  gabdata.join$turnout_perc[gabdata.join$turnout_perc == Inf] = NA
  gabdata.join$sameday_reg_prop = with(gabdata.repunit, election_day_registrants / open_registrants)
...
# Got to here -------------------------------------------------------------
  ...
  table(gov.2018.l$reporting_unit %in% gabdata.join$reporting_unit)
  ...
  setdiff(gov.2018.l$reporting_unit, gabdata.join$reporting_unit)
...
final_model <- rbind(model_2008_pres_repunit, model_2010_cong_repunit, model_2010_sen_repunit, model_2010_gov_repunit, model_2012_pres_repunit, model_2014_cong_repunit, model_2014_gov_repunit, model_2016_pres_repunit)

write.csv(final_model, "Prepped files/all_contests_2008_2016_repunit.csv")
