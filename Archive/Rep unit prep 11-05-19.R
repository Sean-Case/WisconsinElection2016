...
{ # Preparing basic data
  ...
  gov.2018[,7:length(gov.2018)] <- lapply(gov.2018[,7:length(gov.2018)], as.numeric)
...
{ # Making model df
  ...
  model.2018.gov.repunit.df2 = with(model.2018.gov.repunit.df, data.frame(reporting_unit, reporting_unit_orig, county, muni_county, hindi, votes_perc_republican, votes_perc_democrat, votes_perc_other,turnout_perc, tch_prop, os_prop, counted_absent_prop,rejected_absent_prop, absentee_undeliverable,
...
{ # Preparing basic data
  ...
  sen.2018[,7:length(sen.2018)] <- lapply(sen.2018[,7:length(sen.2018)], as.numeric)
...
{ # Making model df
  ...
  model.2018.sen.repunit.df2 = with(model.2018.sen.repunit.df, data.frame(reporting_unit, reporting_unit_orig, county, muni_county, hindi, votes_perc_republican, votes_perc_democrat, votes_perc_other,turnout_perc, tch_prop, os_prop, counted_absent_prop,rejected_absent_prop, absentee_undeliverable,
                                                                          sameday_reg_prop, total_ballots,registrants,late_registrants, votes_tot,
                                                                          county_paper_or_paperplusmachine,
                                                                          ratio_nocollege_college, log.pop.sq.mile.2010,
                                                                          pop_sq_mile_2010,tch_model_off_full, os_model_off, bmd_model_off,
...
{ # Making model df
  ...
  model.2018.state.repunit.df2 = with(model.2018.state.repunit.df, data.frame(reporting_unit, reporting_unit_orig, county, muni_county, hindi, votes_perc_republican, votes_perc_democrat, votes_perc_other,turnout_perc, tch_prop, os_prop, counted_absent_prop,rejected_absent_prop, absentee_undeliverable,
                                                                          sameday_reg_prop, total_ballots,registrants,late_registrants, votes_tot,
                                                                          county_paper_or_paperplusmachine,
                                                                          ratio_nocollege_college, log.pop.sq.mile.2010,
                                                                          pop_sq_mile_2010,tch_model_off_full, os_model_off, bmd_model_off,
...
{ # Making model df
  ...
  model.2016.pres.repunit.df2 = with(model.2016.pres.repunit.df, data.frame(reporting_unit, reporting_unit_orig, county, muni_county, hindi, votes_perc_republican, votes_perc_democrat, votes_perc_other,turnout_perc, tch_prop, os_prop, counted_absent_prop,rejected_absent_prop, absentee_undeliverable,
                                                                          sameday_reg_prop, total_ballots,registrants,late_registrants, votes_tot,
                                                                          county_paper_or_paperplusmachine,
                                                                          ratio_nocollege_college, log.pop.sq.mile.2010,
                                                                          pop_sq_mile_2010,tch_model_off_full, os_model_off, bmd_model_off,
...
{ # Making model df
  ...
  model.2012.pres.repunit.df2 = with(model.2012.pres.repunit.df, data.frame(reporting_unit, reporting_unit_orig, county, muni_county, hindi, votes_perc_republican, votes_perc_democrat, votes_perc_other,turnout_perc, tch_prop, os_prop, counted_absent_prop,rejected_absent_prop, absentee_undeliverable,
                                                                            sameday_reg_prop, total_ballots,registrants,late_registrants, votes_tot,
                                                                            county_paper_or_paperplusmachine,
                                                                            ratio_nocollege_college, log.pop.sq.mile.2010,
                                                                            pop_sq_mile_2010,tch_model_off_full, os_model_off, bmd_model_off,
...
{ # Matching voting statistics with the election statistics
  ...
  gabdata.join$total_ballots = ifelse(gabdata.repunit$total_ballots == 0,
                                      gabdata.repunit$total_electors,
                                      gabdata.repunit$total_ballots)
  gabdata.join$tch_prop = with(gabdata.repunit, dre_touchscreen_auto_mark / total_ballots)
  gabdata.join$tch_prop = ifelse(gabdata.join$tch_prop>1, 1, gabdata.join$tch_prop)
...
{ # Making model df
  ...
  model.2010.gov.repunit.df2 = with(model.2010.gov.repunit.df, data.frame(reporting_unit, reporting_unit_orig, county, muni_county, hindi, votes_perc_republican, votes_perc_democrat, votes_perc_other,turnout_perc, tch_prop, os_prop, counted_absent_prop,rejected_absent_prop, absentee_undeliverable,
                                                                          sameday_reg_prop, total_ballots,registrants,late_registrants, votes_tot,
                                                                          county_paper_or_paperplusmachine,
                                                                          ratio_nocollege_college, log.pop.sq.mile.2010,
                                                                          pop_sq_mile_2010,tch_model_off_full, os_model_off, bmd_model_off,
...
{ # Making model df
  ...
  model.2010.sen.repunit.df2 = with(model.2010.sen.repunit.df, data.frame(reporting_unit, reporting_unit_orig, county, muni_county, hindi, votes_perc_republican, votes_perc_democrat, votes_perc_other,turnout_perc, tch_prop, os_prop, counted_absent_prop,rejected_absent_prop, absentee_undeliverable,
                                                                          sameday_reg_prop, total_ballots,registrants,late_registrants, votes_tot,
                                                                          county_paper_or_paperplusmachine,
                                                                          ratio_nocollege_college, log.pop.sq.mile.2010,
                                                                          pop_sq_mile_2010,tch_model_off_full, os_model_off, bmd_model_off,
...
{ # Making model df
  ...
  model.2010.cong.repunit.df2 = with(model.2010.cong.repunit.df, data.frame(reporting_unit, reporting_unit_orig, county, muni_county, hindi, votes_perc_republican, votes_perc_democrat, votes_perc_other,turnout_perc, tch_prop, os_prop, counted_absent_prop,rejected_absent_prop, absentee_undeliverable,
                                                                            sameday_reg_prop, total_ballots,registrants,late_registrants, votes_tot,
                                                                            county_paper_or_paperplusmachine,
                                                                            ratio_nocollege_college, log.pop.sq.mile.2010,
                                                                            pop_sq_mile_2010,tch_model_off_full, os_model_off, bmd_model_off,
...
{ # Making model df
  ...
  model.2008.pres.repunit.df2 = with(model.2008.pres.repunit.df, data.frame(reporting_unit, reporting_unit_orig, county, muni_county, hindi, votes_perc_republican, votes_perc_democrat, votes_perc_other,turnout_perc, tch_prop, os_prop, counted_absent_prop,rejected_absent_prop, absentee_undeliverable,
                                                                            sameday_reg_prop, total_ballots,registrants,late_registrants, votes_tot,
                                                                            county_paper_or_paperplusmachine,
                                                                            ratio_nocollege_college, log.pop.sq.mile.2010,
                                                                            pop_sq_mile_2010,tch_model_off_full, os_model_off, bmd_model_off,
...
model_2008_pres_repunit$trump_vs_clinton <- "Not 2016 election"
...
model_2010_cong_repunit$trump_vs_clinton <- "Not 2016 election"
...
model_2010_sen_repunit$trump_vs_clinton <- "Not 2016 election"
...
model_2010_gov_repunit$trump_vs_clinton <- "Not 2016 election"
...
model_2012_pres_repunit$trump_vs_clinton <- "Not 2016 election"
...
model_2014_cong_repunit$trump_vs_clinton <- "Not 2016 election"
...
model_2014_gov_repunit$trump_vs_clinton <- "Not 2016 election"
...
model_2016_pres_repunit$trump_vs_clinton <- "Presidential 2016 election"
...
model_2018_gov_repunit$trump_vs_clinton <- "Not 2016 election"
...
model_2018_sen_repunit$trump_vs_clinton <- "Not 2016 election"
...
model_2018_state_repunit$trump_vs_clinton <- "Not 2016 election"

#

which(names(model_2008_pres_repunit) %!in% names(model_2018_gov_repunit))

names(model_2008_pres_repunit)[39] # There is no muni.dense. Because I didn't do the carto bit I guess.

final_model <- rbind(model_2008_pres_repunit, model_2010_cong_repunit, model_2010_sen_repunit, model_2010_gov_repunit, model_2012_pres_repunit, model_2014_cong_repunit, model_2014_gov_repunit, model_2016_pres_repunit, model_2018_gov_repunit, model_2018_sen_repunit, model_2018_state_repunit)
